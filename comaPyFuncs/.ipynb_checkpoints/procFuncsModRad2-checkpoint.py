...
def interpolate_shape(image, methodint='', verbose=False):
    """
    Takes in a function and interpolates the ellipse. Its not in here that it became wrong slopped and stirated
    """
